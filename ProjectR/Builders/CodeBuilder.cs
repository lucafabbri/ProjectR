...
namespace ProjectR
{
    internal class CodeBuilder
    {
        ...
        public string BuildSource(INamedTypeSymbol mapperSymbol, MappingPlan projectAsPlan, MappingPlan buildPlan, MappingPlan applyToPlan)
        {
            var dependencies = GetDependencies(projectAsPlan, buildPlan, applyToPlan);
            BuildHeader(mapperSymbol.ContainingNamespace.ToDisplayString());
        ...
        private void BuildHeader(string namespaceName)
        {
